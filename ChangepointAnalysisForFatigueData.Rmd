...
author:
  ...
  - Ehsan T. Esfahani^[Department of Mechanical and Aerospace Engineering, University at Buffalo. ]
...
for (i in 1:length(num_subjects)) {
  ...
  raw_data <- readMat(paste0("https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/Raw/Subject",num_subjects[i],".mat?raw=true"))
...
for (i in 1:15) {
  ...
  cat(' \n \n')
  cat('<source> <p> The data processed with the median filtered approach is stored at the <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/MedianFilteredData.RData">following location</a> in our GitHub Repository.')
  cat('\n \n')
...
```{r CUSUM, fig.align='center', results='asis', out.width='65%', message=FALSE, cache=TRUE}
  ...
  cat('<source> <p> The results from the analysis above can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/CusumData.RData">CusumData.RData</a>. </p> </source>')
  cat('\n \n')
  }
...
RPE = read.csv("https://raw.githubusercontent.com/AmirBGitHub/fatigue-changepoint/master/Data/Raw/RPE.csv") # to read subjective rating of RPE data from GitHub'
...
#             '.  <font color= #63B8FF>    
    ...
    cat(paste0('<source> <p>  <font color= #63B8FF> <b> The threshold based changepoint in the subjective RPE is located at: ',
             ...
             '. </b> </font> The results from the analysis above can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/PCAChangepointsRPE.RData">PCAChangepointsRPE.RData</a>. </p> </source>')
      )
...
```{r MCP_MedianFilteredData, cache=TRUE, fig.align='center', results='asis', out.width='65%', message=FALSE}
  ...
  cat(paste0('<source> <p> Based on the <b>ecp package</b>, the number of changepoints for participant ', i,
             ...
             '. The results from the analysis above can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/ECPChangePointsMFData.RData">ECPChangePointsMFData.RData</a>. </p> </source>')
      )
  cat('\n \n')
  }
...
```{r MCP_MedianFilteredDiffData, cache=TRUE, fig.align='center', results='asis', out.width='65%', message=FALSE}
  ...
  cat(paste0('<source> <p> Based on the <b>ecp package</b>, the number of changepoints for the median filtered differenced data for participant ', i,
             ...
             '. The results from the analysis above can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/ECPChangePointsDiffMFData.RData">ECPChangePointsDiffMFData.RData</a>. </p> </source>')
      )
...
load(file = "./Data/RGenerated/CusumData.RData")
  ...
  cat(paste0('<source> <p> Based on the <b>ecp package</b>, the number of changepoints for the cusums of the median filtered data for participant ', i,
             ...
             '. The results from the analysis above can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/ECPChangePointsCUSUM.RData">ECPChangePointsCUSUM.RData</a>. </p> </source>')
      )
  cat('\n \n')
  }
...
```{r MPH1_MF, cache=TRUE, fig.align='center', results='asis', out.width='65%', message=FALSE}
 ...
 cat('\n')
  ...
  cat(paste0('<source> <p> Based on the <b>dfphase1 package</b>, the number of changepoints for the cusums of the median filtered data for participant ', i,
             ...
             '. These changepoints are located at: ',
             paste(mcp, collapse = ", "),
             '. The results from the analysis above can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/ChangePointsMedianFilterMphase1.RData">ChangePointsMedianFilterMphase1.RData</a>. </p> </source>')
  )
  cat('\n \n')
  }
...
```{r MPH1_CUSUM, cache=TRUE, fig.align='center', results='asis', out.width='65%', message=FALSE}
 ...
 cat('\n')
  ...
  cat(paste0('<source> <p> Based on the <b>dfphase1 package</b>, the number of changepoints for the cusums of the median filtered data for participant ', i,
             ...
             '. These changepoints are located at: ',
             paste(mcp, collapse = ", "),
             '. The results from the analysis above can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/ChangePointsCusumMphase1.RData">ChangePointsCusumMphase1.RData</a>. </p> </source>')
  )
  cat('\n \n')
  }
...
'. Fourth, the <b> <font color=#FFA500> orange lines  are used to denote the univariate, nonparametric changepoints obtained from applying the e.divisive() on the CUSUM of the RPE values. </font> </b> \n \n'))
  ...
  cat(paste0('<source> <p> Based on the <b>ecp package, the number of changepoints for the the median filtered data for participant ', i,
             ...
             ". These changepoints are located at: ",
             paste(changepoints_cusum_subj_ecp[[i]], collapse = ", "),
             '. </b> </font> The results from the analysis above can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/ChangepointsRPE.RData">ChangepointsRPE.RData</a>. </p> </source>')
      )
...
for (i in 1:15) {
  ...
  cat(paste0('</b> </font> The normalized data can be found at: <a href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/NormMedianFilteredData.RData">NormMedianFilteredData.RData</a> and <a 
href="https://github.com/AmirBGitHub/fatigue-changepoint/blob/master/Data/RGenerated/NormCusumData.RData">NormCusumData.RData</a> </p> </source>')
  )
