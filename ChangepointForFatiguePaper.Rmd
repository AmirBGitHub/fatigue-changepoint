...
The snippet below documents the list of **R** libraries that were used in this research. For convenience, we used the \textit{pacman} package since it allows for installing/loading the needed libraries in one step.
...
The results from rescaling the data can be found at [ScaledData.RData](https://github.com/AmirBGitHub/fatigue-changepoint/data/RGenerated/).
...
The rescaled and then median filtered data can be found at: [NormMedianFilteredData.RData](https://github.com/AmirBGitHub/fatigue-changepoint/data/RGenerated/). Additionally, the cusum of this data (which we use for interpretation) can be found at: [NormCusumData.RData](https://github.com/AmirBGitHub/fatigue-changepoint/data/RGenerated/)
...
RPE = read.csv("./data/Raw/RPE.csv") # to read subjective rating of RPE data'
...
The results from this analysis are saved at The subjective ratings for each participant can be accessed at: [MFClusters.RData](https://github.com/AmirBGitHub/fatigue-changepoint/data/RGenerated).
...
The results from this analysis are saved at The subjective ratings for each participant can be accessed at: [CusumClusters.RData](https://github.com/AmirBGitHub/fatigue-changepoint/data/RGenerated). 